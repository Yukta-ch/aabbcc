...
#Background Information:
  ...
  Hyperledger Fabric: 
   ...
   • It is designed to support the development of scalable and secure blockchain applications and is suitable for a wide range of use cases, 
    including supply chain management, identity management, and financial services.
  Hyperledger Fabric SDK:
  • Hyperledger Fabric SDK is a software development kit (SDK) that 
    provides a set of tools and libraries for building applications that interact with a Hyperledger Fabric blockchain. 
  ...
  Application SDKS: To develop your blockchain application.
     The Application: Blockchain application will utilize the Application SDKs to call 
                      smart contracts running on a Fabric network.




Installation steps:
     1. Java Development Kit (JDK) 11 or later: Install JDK 11 or a later version on your system. You can download it from Java Downloads | Oracle
     2. Install Ubuntu app from windows store: Open the Microsoft Store and install Ubuntu 22.04.02 LTS .
     3. Open Windows Terminal (Command Prompt) and add a new ubuntu tab.
   Now “Ubuntu 22.04.02 LTS” is linked to Windows terminal.4. Updating and installing basic packages for Ubuntu.
             #sudo apt update && sudo apt upgrade
     4. Open Windows Terminal (Command Prompt) and add a new ubuntu tab.
 Now “Ubuntu 22.04.02 LTS” is linked to Windows terminal
     5. Docker Desktop 4.25.2 or later (if using Dockized environment):Install Docker Desktop 4.25.2 or a later version if you want to use the 
        Dockerized environment. 
        You can download it fromDocker Desktop: The #1 Containerization Tool for Developers | Docker
